...
class Settings(BaseSettings):
    # Application
    APP_NAME: str = "AIPAL Backend Services"
    ...
    # Database
    DATABASE_URL: str = Field(default="postgresql+asyncpg://postgres:postgres@localhost:5432/aipal")
    ...
    # OpenTelemetry
    OTEL_SERVICE_NAME: str = Field(default="aipal-backend")
